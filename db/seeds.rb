...
slot_2 = FactoryBot.create(:time_slot, doctor: doctor_1, start_time: current_time + three_days)
slot_3 = FactoryBot.create(:time_slot, :booked, doctor: doctor_1, start_time: current_time + five_days)
slot_4 = FactoryBot.create(:time_slot, :booked, doctor: doctor_1, start_time: current_time + five_days + delta_time)
slot_5 = FactoryBot.create(:time_slot, doctor: doctor_2, start_time: current_time)
slot_6 = FactoryBot.create(:time_slot, :booked, doctor: doctor_2, start_time: current_time + three_days)
slot_7 = FactoryBot.create(:time_slot, :booked, doctor: doctor_2, start_time: current_time + three_days + delta_time)
slot_8 = FactoryBot.create(:time_slot, doctor: doctor_2, start_time: current_time + five_days)
